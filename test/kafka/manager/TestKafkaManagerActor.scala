...
class TestKafkaManagerActor extends CuratorAwareTest with BaseTest {
  ...
  test("add cluster") {
    val cc = ClusterConfig("dev","2.8.1",testServer.getConnectString, jmxEnabled = false, pollConsumers = true, filterConsumers = true, jmxUser = None, jmxPass = None, jmxSsl = false, tuning = Option(defaultTuning), securityProtocol="PLAINTEXT", saslMechanism = None, jaasConfig = None)
  ...
  test("update cluster zkhost") {
    val cc2 = ClusterConfig("dev","2.8.1",kafkaServerZkPath, jmxEnabled = false, pollConsumers = true, filterConsumers = true, jmxUser = None, jmxPass = None, jmxSsl = false, tuning = Option(defaultTuning), securityProtocol="PLAINTEXT", saslMechanism = None, jaasConfig = None)
  ...
  test("update cluster logkafka enabled") {
    val cc2 = ClusterConfig("dev","2.8.1",kafkaServerZkPath, jmxEnabled = false, pollConsumers = true, filterConsumers = true, logkafkaEnabled = true, jmxUser = None, jmxPass = None, jmxSsl = false, tuning = Option(defaultTuning), securityProtocol="PLAINTEXT", saslMechanism = None, jaasConfig = None)
    withKafkaManagerActor(KMUpdateCluster(cc2)) { result: KMCommandResult =>
      result.result.get
      Thread.sleep(3000)
    }
  ...
  test("update cluster tuning") {
    ...
    val cc2 = ClusterConfig("dev","2.8.1",kafkaServerZkPath, jmxEnabled = false, pollConsumers = true, filterConsumers = true, logkafkaEnabled = true, jmxUser = None, jmxPass = None, jmxSsl = false,
  ...
  test("update cluster security protocol") {
    val cc2 = ClusterConfig("dev","2.8.1",kafkaServerZkPath, jmxEnabled = false, pollConsumers = true, filterConsumers = true, logkafkaEnabled = true, jmxUser = None, jmxPass = None, jmxSsl = false, tuning = Option(defaultTuning), securityProtocol="SASL_PLAINTEXT", saslMechanism = Option("PLAIN"), jaasConfig = Option("blah"))
    withKafkaManagerActor(KMUpdateCluster(cc2)) { result: KMCommandResult =>
      result.result.get
      Thread.sleep(3000)
    }
